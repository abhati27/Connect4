...
public class Themes {
    ...
    public String originalPlayer1Color = "-fx-color: orangered;";
    public String originalPlayer2Color = "-fx-color: yellow;";

    public Background theme1Color;
    public String theme1Player1Color = "-fx-color: mediumpurple;";
    public String theme1Player2Color = "-fx-color: limegreen;";

    public Background theme2Color;
    public String theme2Player1Color = "-fx-color: hotpink;";
    public String theme2Player2Color = "-fx-color: midnightblue;";

    public Themes() {
        originalColor = new Background(new BackgroundFill(Color.STEELBLUE, null, null));
        theme1Color = new Background(new BackgroundFill(Color.LIGHTSKYBLUE, null, null));
        theme2Color = new Background(new BackgroundFill(Color.PALETURQUOISE, null, null));
    }
